 ...
 */
        ...
        const telPopup = document.getElementById("tel-popup");
        if (tel) Inputmask({
            mask: "+7 (9 9 9) 9 9 9-9 9-9 9"
        }).mask(tel);
        if (telPopup) Inputmask({
            mask: "+7 (9 9 9) 9 9 9-9 9-9 9"
        }).mask(telPopup);
        ...
        function calculator() {
            if (calculatorBlock) {
                ...
                btn.addEventListener("click", (function(e) {
                    ...
                    volumePopup.innerHTML = totalVolume.toFixed(2);
                    autoPopup.innerHTML = Math.ceil(totalVolume / 25);
                }));
            }
        }
        calculator();
        function scrollPrice() {
            let scroll = document.querySelector(".table-price__body");
            if (scroll) {
                let speed = 2;
                let left = 0;
                let top = 0;
